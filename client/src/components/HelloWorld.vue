        ...
        <div class>
          <div class="card">
            <div class="header" style="padding:20px 0px 0px 20px">
              <div class="row">
                <div class="col-md-4">
                  <span class="h_page">Beranda</span>
                </div>
                  ...
                  <table class="table table-bordered" style="width: 100%">
                      <thead>
                          <tr class="bg-info">
                              ...
                              <th class="text-center" style="width: 20%">Youtube</th>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="row clearfix">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input v-model="youtube" type="text" class="form-control" placeholder="Youtube">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input  @change="onFileSelected" type="file" class="form-control" placeholder="Gambar" accept="img/.">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
const ADD_URL = URL_APP + "api/v1/web_home/";
